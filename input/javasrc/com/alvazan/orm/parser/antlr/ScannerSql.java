...
public class ScannerSql {
	...
	private <T> void processUpdate(CommonTree tree,
			InfoForWiring wiring, MetaFacade facade) {
		//ExpressionNode updateData = wiring.getUpdateTree();
		//ExpressionNode columnName = updateData.getChild(ChildSide.LEFT);
		//ExpressionNode value = updateData.getChild(ChildSide.RIGHT);
